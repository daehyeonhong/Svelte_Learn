...
var app = (function () {
    ...
    let storeName = writable('Svelte');

    /* src\Child.svelte generated by Svelte v3.46.3 */
    const file$1 = "src\\Child.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			t0 = text("Child ");
    			t1 = text(/*$storeName*/ ctx[0]);
    			add_location(div, file$1, 3, 0, 64);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$storeName*/ 1) set_data_dev(t1, /*$storeName*/ ctx[0]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $storeName;
    	validate_store(storeName, 'storeName');
    	component_subscribe($$self, storeName, $$value => $$invalidate(0, $storeName = $$value));
    	...
    	$$self.$capture_state = () => ({ storeName, $storeName });
    	return [$storeName];
    }
    ...
    /* src\Parent.svelte generated by Svelte v3.46.3 */
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ storeName, Parent, name, $storeName });
