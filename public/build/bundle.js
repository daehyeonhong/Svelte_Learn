...
var app = (function () {
    ...
    /* src\Todo.svelte generated by Svelte v3.46.3 */
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button0, file$1, 36, 8, 761);
    			add_location(button1, file$1, 37, 8, 810);
    			add_location(div, file$1, 34, 4, 724);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button1, "click", /*deleteTodo*/ ctx[7], false, false, false)
    				];
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(input, file$1, 27, 8, 474);
    			add_location(button0, file$1, 30, 8, 603);
    			add_location(button1, file$1, 31, 8, 654);
    			add_location(div, file$1, 26, 4, 459);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const keydown_handler = e => e.key === 'Enter' && updateTodo();
    ...
    function create_each_block(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(27:0) {#each $todos as todo}",
    		ctx
    	});
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			each_1_anchor = empty();
    			attr_dev(input, "type", "text");
    			add_location(input, file, 22, 0, 434);
    			add_location(button, file, 25, 0, 539);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	const keydown_handler = e => e.key === 'Enter' && createTodo();
